...
borough_choices = 
  nyc_airbnb %>% 
  distinct(borough) %>% 
  pull() ## pull not distinct b/c pull will give a vector that's what we want not dataframe


selectInput(
  "borough_choice",
  label = h3("Select Borough"), ## h3 is size font -- header 3
